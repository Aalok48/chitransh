...
const PROJECTS = [
  ...
  { client: "Huawei Nepal", logo: "/clientlogo/huaweilogo.jpeg", sub: "Digital Education", type: "Documentary", desc: "A refined video documentary elegantly showcasing the impact and transformative benefits of digital education.", url: "https://blog.huawei.com/admin/asset/v1/pro/view/4-fa85a68997442309c8e10d3f975268d.mp4", tag: "Documentary" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : isTablet ? "1fr 1fr" : "repeat(3, 1fr)", gap: 20 }}>
          {PROJECTS.map((p, i) => (
            ...
            >
              ...
              <h3 style={{ color: T.navy, fontSize: 16, fontWeight: 700, marginBottom: 4 }}>{p.client}</h3>
              <p style={{ color: p.isIT ? T.blue : T.accent, fontSize: 12, fontWeight: 600, marginBottom: 10 }}>{p.sub}</p>
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "center", marginBottom: 18 }}>
                <div style={{
                  ...
                  background: "#fff",
                  border: `1px solid ${T.borderCard}`,
                  boxShadow: "0 2px 12px rgba(30,42,58,0.08)",
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "center", marginBottom: 18 }}>
                <div style={{
                  width: 80, height: 80,
                  borderRadius: 16,
                  background: p.isIT ? "#EAF3FB" : T.bgAlt,
                  border: `1px solid ${T.borderCard}`,
                  boxShadow: "0 2px 12px rgba(30,42,58,0.08)",
                  display: "flex", alignItems: "center", justifyContent: "center",
